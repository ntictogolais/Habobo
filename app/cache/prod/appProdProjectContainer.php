...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'H:\\habobo\\app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $a = $this->get('templating.loader');
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('H:\\habobo\\app/cache/prod/assetic/config'), false)));
    ...
    protected function getCacheWarmerService()
    {
        ...
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($this), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 3 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c), 4 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine')), 5 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetWriterCacheWarmer($this, new \Assetic\AssetWriter('H:\\habobo\\app/../web')), 6 => new \Symfony\Bundle\DoctrineMongoDBBundle\CacheWarmer\ProxyCacheWarmer($this), 7 => new \Symfony\Bundle\DoctrineMongoDBBundle\CacheWarmer\HydratorCacheWarmer($this)));
    }
    ...
    protected function getDoctrine_Odm_Mongodb_DefaultConfigurationService()
    {
        ...
        $instance->setProxyDir('H:\\habobo\\app/cache/prod/doctrine/odm/mongodb/Proxies');
        $instance->setProxyNamespace('Proxies');
        $instance->setAutoGenerateProxyClasses(false);
        $instance->setHydratorDir('H:\\habobo\\app/cache/prod/doctrine/odm/mongodb/Hydrators');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_4aa4ecbd08951a1df8957d84934ad2bf');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_4aa4ecbd08951a1df8957d84934ad2bf');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_4aa4ecbd08951a1df8957d84934ad2bf');
        ...
        $d->setProxyDir('H:\\habobo\\app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['fos_facebook.helper'] = new \FOS\FacebookBundle\Templating\Helper\FacebookHelper($this->get('templating'), $this->get('fos_facebook.api'), false, 'en_US', array(0 => 'email', 1 => 'user_website', 2 => 'user_birthday', 3 => 'user_location', 4 => 'user_about_me', 5 => 'user_activities', 6 => 'user_education_history', 7 => 'user_interests', 8 => 'user_online_presence', 9 => 'xmpp_login'));
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('H:\\habobo\\app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => 'php', 'translation.loader.yml' => 'yml', 'translation.loader.xliff' => 'xliff'), array('cache_dir' => 'H:\\habobo\\app/cache/prod/translations', 'debug' => false), $this->get('session'));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => 'H:\\habobo\\app/cache/prod/twig', 'charset' => 'UTF-8'));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, new \Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->getDefaultParameters()), 'H:\\habobo\\app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'H:\\habobo\\app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'H:\\habobo\\app/cache/prod',
            ...
            'router.resource' => 'H:\\habobo\\app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'H:\\habobo\\app/cache/prod/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'doctrine.orm.proxy_dir' => 'H:\\habobo\\app/cache/prod/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => 'H:\\habobo\\app/cache/prod/assetic',
            ...
            'doctrine.odm.mongodb.proxy_dir' => 'H:\\habobo\\app/cache/prod/doctrine/odm/mongodb/Proxies',
            'doctrine.odm.mongodb.auto_generate_proxy_classes' => false,
            'doctrine.odm.mongodb.hydrator_namespace' => 'Hydrators',
            'doctrine.odm.mongodb.hydrator_dir' => 'H:\\habobo\\app/cache/prod/doctrine/odm/mongodb/Hydrators',
